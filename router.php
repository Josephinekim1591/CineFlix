...
const ROUTES = array(
  "/" => "pages/consumer-view-all.php",
  "/movie-details" => "pages/movie-details.php",
  "/admin/movies" => "pages/admin-view-all.php",
  "/admin/movies/edit" => "pages/admin-edit.php",
  "/add-movies" => "pages/insert-entry.php",
